              ...
              <div>
                ...
                <Reavel>
                  <p className="dark:text-white text-slate-700">
                    Welcome to{" "}
                    <span className="font-semibold">Khelo Mewat</span>, where
                    passion, dedication, and excellence converge.
                  </p>
                </Reavel>
                <Reavel>
                  <p className="dark:text-white text-slate-700">
                    At Khelo Mewat, we're more than just a sports organization.
                    We're a community united by a love for sports and a
                ...
                <Reavel>
                  <p className="dark:text-white text-slate-700">
                    ...
                    player aiming for new heights, Khelo Mewat welcomes you.
                    Join us on a journey of skill development, camaraderie, and
                    sportsmanship.
                  </p>
                </Reavel>
              </div>
                  ...
                  <ul className="list-disc ps-6">
                    ...
                    <Reavel>
                      <li>
                        ...
                        Our supportive community of athletes, parents, and
